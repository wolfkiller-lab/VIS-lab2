(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["visComponents"] = factory();
	else
		root["visComponents"] = factory();
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_vue_vue_type_style_index_0_id_a98a1f60_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("2d43");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_vue_vue_type_style_index_0_id_a98a1f60_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_vue_vue_type_style_index_0_id_a98a1f60_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_vue_vue_type_style_index_0_id_a98a1f60_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_map_vue_vue_type_style_index_0_id_7af2b792_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("f1c3");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_map_vue_vue_type_style_index_0_id_7af2b792_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_map_vue_vue_type_style_index_0_id_7af2b792_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_tree_map_vue_vue_type_style_index_0_id_7af2b792_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_bar_chart_vue_vue_type_style_index_0_id_3fd5fff2_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("6f17");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_bar_chart_vue_vue_type_style_index_0_id_3fd5fff2_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_bar_chart_vue_vue_type_style_index_0_id_3fd5fff2_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_bar_chart_vue_vue_type_style_index_0_id_3fd5fff2_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_sunburst_vue_vue_type_style_index_0_id_42633710_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("be18");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_sunburst_vue_vue_type_style_index_0_id_42633710_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_sunburst_vue_vue_type_style_index_0_id_42633710_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_6_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_sunburst_vue_vue_type_style_index_0_id_42633710_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
__webpack_require__.d(__webpack_exports__, "Tree", function() { return /* reexport */ tree_tree; });
__webpack_require__.d(__webpack_exports__, "TreeMap", function() { return /* reexport */ tree_map; });
__webpack_require__.d(__webpack_exports__, "Sunburst", function() { return /* reexport */ sunburst; });
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"15cc0b78-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/bar-chart/bar-chart.vue?vue&type=template&id=3fd5fff2&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{style:({width:600,height:600}),attrs:{"id":"bar-chart-container"}})}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/bar-chart/bar-chart.vue?vue&type=template&id=3fd5fff2&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/bar-chart/bar-chart.vue?vue&type=script&lang=js&
...
/* harmony default export */ var bar_chartvue_type_script_lang_js_ = ({
  name: 'BarChart',
  props: ['options'],
  data: function data() {
    return {
  ...
  computed: {
    ...
    ascendingData: function ascendingData() {
      // 升序排序
      return this.sortKeyAscending(this.originData, 'value');
    },
    descendingData: function descendingData() {
      // 降序排序
  ...
  watch: {
    ...
    'options.titleBackground': {
      handler: function handler() {
        if (this.options.titleIsShow) {
          this.title.select('rect').attr('fill', "".concat(this.options.titleBackground));
        }
      }
    },
    'options.titleFontColor': {
      handler: function handler() {
        if (this.options.titleIsShow) {
          this.title.select('text').attr('fill', "".concat(this.options.titleFontColor));
        }
      }
    },
      ...
      handler: function handler() {
        if (this.options.titleIsShow) {
          ...
          switch (this.options.titleTextPosition) {
            case 'center':
              this.title.select('text').attr('text-anchor', 'middle').attr('x', 350);
              break;

            case 'left':
              this.title.select('text').attr('text-anchor', 'start').attr('x', 10);
              break;

            case 'right':
              this.title.select('text').attr('text-anchor', 'end').attr('x', 690);
              break;
    ...
    'options.titleFontFamily': {
      handler: function handler() {
        if (this.options.titleIsShow) {
          this.title.select('text').attr('font-family', "".concat(this.options.titleFontFamily));
        }
      }
    },
    'options.titleFontSize': {
      handler: function handler() {
        if (this.options.titleIsShow) {
          this.title.select('text').attr('font-size', "".concat(this.options.titleFontSize));
        }
      }
    },
      ...
      handler: function handler() {
        if (this.options.legendIsShow) {
          if (this.options.legendAlign === 'vertical') {
            ...
            ;
            this.legend = this.legendBox.selectAll('.legend').attr('transform', function (d, i) {
              return "translate(10, ".concat(i * 25, ")");
            });
          } else {
            // 水平排列
            ...
            this.legend = this.legendBox.selectAll('.legend').attr('transform', function (d, i) {
              return "translate(".concat(i * 70, ",0)");
            });
          } // 更新图例位置
      ...
      handler: function handler() {
        if (this.options.xAxisIsShow) {
          ...
          if (this.options.xAxisPosition === 'top') {
            this.xAxis.attr('transform', 'translate(0, 0)').call(axisTop(this.xscale));
            this.xAxis.selectAll('.tick').selectAll('.axis-label').attr('transform', 'translate(0,-5)'); // 更新y轴--当x轴载上方时,y轴要进行反转

            this.updateYAxis(); // 所有bar上沿对齐

            this.chart.selectAll('.bar').attr('y', 0);
          } else {
            this.xAxis.attr('transform', "translate(0, ".concat(this.height, ")")).call(axisBottom(this.xscale));
            this.xAxis.selectAll('.tick').selectAll('.axis-label').attr('transform', 'translate(0,0)'); // 更新y轴

            this.updateYAxis();
            ys = this.yscale; // 所有bar下沿对齐
          ...
          if (this.options.yAxisPosition === 'left') this.yAxis.attr('transform', 'translate(0, 0)').call(axisLeft(this.yscale).ticks(6));else this.yAxis.attr('transform', "translate(".concat(this.width, ",0)")).call(axisRight(this.yscale).ticks(6)); // 更新bar对应的数据标签位置
      ...
      handler: function handler() {
        if (this.options.yAxisIsShow) {
          if (this.options.yAxisPosition === 'left') {
            this.yAxis.attr('transform', 'translate(0, 0)').call(axisLeft(this.yscale).ticks(6));
            this.yAxis.selectAll('.tick').selectAll('.axis-label').attr('text-anchor', 'end');
            this.yAxis.selectAll('.grid').attr('x2', this.width);
          } else {
            this.yAxis.attr('transform', "translate(".concat(this.width, ",0)")).call(axisRight(this.yscale).ticks(6));
    ...
    'options.tooltipPadding': {
      handler: function handler() {
        ...
        var chartpadding = this.chartPadding; // 修改鼠标悬浮事件

        this.chart.on('mouseover', function (d) {
          var x = on_event.layerX - 50 - chartpadding.left;
          var y = on_event.layerY - chartpadding.top;
          src_select('.tooltip').attr('transform', "translate(".concat(x, ",").concat(y, ")")).attr('opacity', 0.7);
          src_select('.tooltip').select('text').text("".concat(d.name, ":").concat(d.value)).attr('width', function () {
            textWidth = this.getComputedTextLength();
            textHeight = this.getBBox().height;
            return 14;
          }); // 更新tooltip矩形的尺寸

          src_select('.tooltip').select('rect').attr('width', textWidth + padding.left + padding.right).attr('height', textHeight + padding.top + padding.bottom);
        });
        this.tooltip.select('text').attr('transform', "translate(".concat(this.tooltipPadding.left, ",").concat(this.tooltipPadding.top + 12, ")"));
      }
    },
    ...
    'options.tooltipBorder': {
      handler: function handler() {
        this.tooltip.select('rect').attr('style', "stroke-width: ".concat(this.options.tooltipBorder));
      }
    },
    'options.tooltipBorderRadius': {
      handler: function handler() {
        this.tooltip.select('rect').attr('rx', "".concat(this.options.tooltipBorderRadius)).attr('ry', "".concat(this.options.tooltipBorderRadius));
      }
    },
    'options.chartBackground': {
      handler: function handler() {
        this.svg.attr('style', "background: ".concat(this.options.chartBackground));
      }
    },
    'options.chartPadding': {
      handler: function handler() {
        this.chartPadding = this.options.chartPadding; // 更新图表部分尺寸

        this.width = 700 - this.chartPadding.right - this.chartPadding.left - 180;
        this.height = 700 - this.chartPadding.bottom - this.chartPadding.top - 80; // 更新比例尺

        this.xscale = band().domain(this.nameArray).rangeRound([0, this.width]).padding(0.1);
        this.yscale = linear_linear().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([this.height, 0]);
        this.g.attr('transform', "translate(".concat(this.chartPadding.left + 40, ", ").concat(this.chartPadding.top + 40, ")")); // 更新鼠标悬浮事件
        ...
        this.chart.on('mouseover', function (d) {
          ...
          var y = on_event.layerY - chartpadding.top;
          src_select('.tooltip').attr('transform', "translate(".concat(x, ",").concat(y, ")")).attr('opacity', 0.7);
          src_select('.tooltip').select('text').text("".concat(d.name, ":").concat(d.value));
        }); // 更新brush可刷选范围

        this.brush.extent([[0, 0], [this.width, this.height]]);
        this.gBrush.call(this.brush); // 更新图表的绘制
    ...
    'options.colorList': {
      handler: function handler() {
        ...
        this.originData = this.data; // 更新颜色列表后重新传入新数据
    ...
    'options.scrollingIsShow': {
      handler: function handler() {
        if (this.options.scrollingIsShow) {
          src_select('#bar-chart-container').style('overflow', 'scroll');
        } else {
          src_select('#bar-chart-container').style('overflow', 'hidden');
        }
      }
    },
    'options.scrollingWidth': {
      handler: function handler() {
        if (this.options.scrollingIsShow) {
          src_select('#bar-chart-container').style('width', "".concat(this.options.scrollingWidth, "px"));
        }
      }
    },
    'options.scrollingHeight': {
      handler: function handler() {
        if (this.options.scrollingIsShow) {
          src_select('#bar-chart-container').style('height', "".concat(this.options.scrollingHeight, "px"));
        }
      }
    },
    'options.labelIsShow': {
    ...
    'options.sortType': {
      handler: function handler() {
        ...
        switch (this.options.sortType) {
          case 'null':
            this.nameArray = this.data.map(function (item) {
              return item.name;
            });
            this.valueArray = this.data.map(function (item) {
              return item.value;
            });
            this.chart.data(this.data);
            break;
          ...
          case 'ascending':
            this.nameArray = this.ascendingData.map(function (item) {
              return item.name;
            });
            this.valueArray = this.ascendingData.map(function (item) {
              return item.value;
            });
          ...
          case 'descending':
            this.nameArray = this.descendingData.map(function (item) {
              return item.name;
            });
            this.valueArray = this.descendingData.map(function (item) {
              return item.value;
            });
        ...
        this.xscale = band().domain(this.nameArray).rangeRound([0, this.width]).padding(0.1); // 更新图例颜色
  ...
  methods: {
    ...
    sortKeyAscending: function sortKeyAscending(array, key) {
    ...
    sortKeyDescending: function sortKeyDescending(array, key) {
      return array.sort(function (a, b) {
        var x = a[key];
        var y = b[key];
        return y < x ? -1 : x > y ? 1 : 0;
    ...
    initBarChart: function initBarChart() {
      console.log(this.options); // 获取x轴和y轴的标签
      ...
      this.width = 700 - this.chartPadding.right - this.chartPadding.left - 180;
      this.height = 700 - this.chartPadding.bottom - this.chartPadding.top - 80; // 比例尺

      var xscale = band().domain(this.nameArray).rangeRound([0, this.width]).padding(0.1);
      var yscale = linear_linear().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([this.height, 0]).nice();
      this.xscale = xscale;
      this.yscale = yscale;
      src_select('#bar-chart-container').style('width', '720px').style('height', '720px'); // 添加svg

      this.svg = src_select('#bar-chart-container').append('svg').attr('style', 'background: #eee').attr('width', 700).attr('height', 700); // 添加g标签 

      this.g = this.svg.append('g').attr('class', 'chart') // 图表部分
      .attr('transform', "translate(".concat(this.chartPadding.left + 40, ", ").concat(this.chartPadding.top + 40, ")")); // 添加brush

      this.brush = brushX().extent([[0, 0], [this.width, this.height]]) // 刷选范围为图表部分
      .on('brush', this.brushed);
      this.gBrush = src_select('.chart').append('g').attr('class', 'brush').call(this.brush); // 暂存几个变量,以便之后用到

      var chartpadding = this.chartPadding;
      var chartwidth = this.width;
      var chartheight = this.height; // 添加x轴

      this.xAxis = this.g.append('g').attr('class', 'axis').attr('transform', "translate(0, ".concat(this.height, ")")).call(axisBottom(this.xscale)).attr('font-weight', 'blod').attr('font-size', 13);
      this.xAxis.selectAll('.tick').select('line').attr('class', 'axis-tick'); // x轴刻度

      this.xAxis.selectAll('.tick').select('text').attr('class', 'axis-label'); // x轴标签

      this.xAxis.selectAll('.tick').each(function () {
        src_select(this).append('line').attr('class', 'grid') // x轴网格线
        .attr('style', 'display: none').attr('stroke', '#000').attr('stroke-dasharray', '10,10').attr('x1', 0).attr('y1', -chartheight).attr('x2', 0).attr('y2', 0);
      }); // 添加y轴

      this.yAxis = this.g.append('g').attr('class', 'axis').call(axisLeft(this.yscale).ticks(6));
      this.yAxis.selectAll('.tick').select('line').attr('class', 'axis-tick'); // y轴刻度

      this.yAxis.selectAll('.tick').select('text').attr('class', 'axis-label'); // y轴标签

      this.yAxis.selectAll('.tick').each(function () {
        src_select(this).append('line').attr('class', 'grid') // y轴网格线
        .attr('stroke', '#000').attr('stroke-dasharray', '10,10').attr('x1', 0).attr('y1', 0).attr('x2', chartwidth).attr('y2', 0);
      }); // 添加chart,实际上就是bars

      this.chart = this.g.selectAll('#bar-chart-container').data(this.data).enter().append('g');
      this.chart.append('rect').attr('class', 'bar').attr('stroke', 'black').attr('style', 'stroke-width:0').attr('z-index', '100').attr('x', function (item) {
        return xscale(item.name);
      }).attr('width', this.xscale.bandwidth()).attr('y', function (item) {
      ...
      this.dataLabel = this.chart.append('text').attr('class', 'data-label').attr('font-size', 16).attr('text-anchor', 'middle').text(function (item) {
        return item.value;
      ...
      this.tooltip = this.g.append('g').attr('class', 'tooltip').attr('opacity', 0); // 默认不显示

      this.tooltip.append('rect').attr('fill', '#eeeeee').attr('rx', 0).attr('ry', 0).attr('stroke', 'black').attr('style', 'stroke-width:1');
      this.tooltip.append('text').attr('font-size', 12).attr('transform', "translate(".concat(this.tooltipPadding.left, ",").concat(this.tooltipPadding.top + 12, ")"));
      src_select('.tooltip').select('rect').attr('width', 75).attr('height', 23); // 为提示框设置默认尺寸
      // 添加图表标题

      this.title = this.svg.append('g').attr('transform', 'translate(0,0)').attr('style', 'display: none'); // 默认不显示
      // 标题背景框

      this.title.append('rect').attr('class', 'title').attr('width', 700).attr('height', "".concat(this.titleRectHeight)).attr('fill', '#E3E3E3').attr('x', '0').attr('y', '0'); // 标题文本       

      this.title.append('text').text(this.titleText).attr('x', 350).attr('y', 25).attr('text-anchor', 'middle').attr('fill', '#000'); // 添加图例

      this.legendBox = this.g.append('g').attr('style', 'display: block').attr('transform', "translate(".concat(this.width + 40, ",").concat(this.height / 2 - this.legendHeight / 2, ")"));
      this.legend = this.legendBox.selectAll('.legend').data(this.data).enter().append('g').attr('class', 'legend').attr('stroke', 'black').attr('style', 'stroke-width:0').attr('transform', function (d, i) {
        return "translate(10, ".concat(i * 25, ")");
      }); // 图例文本

      this.legend.append('text').attr('transform', 'translate(50,30)').style('text-anchor', 'middle').attr('font-size', 14).text(function (d) {
        return d.name;
      }); // 图例矩形

      this.legend.append('rect').attr('transform', 'translate(5,15)').attr('width', 20).attr('height', 20) // 设低一些就是线，高一些就是面
      .style('fill', function (d) {
        return d.color;
      }); // 用于取消点击图例后bar的边框效果

      this.chart.on('click', function () {
        src_selectAll('.bar').attr('opacity', 1).attr('style', 'stroke-width:0');
      }); // 图例点击后, 对应bar透明度增加并出现边框

      var name;
      this.legend.on('click', function (d) {
        name = d.name;
        src_selectAll('.bar').attr('opacity', function (item) {
          if (item.name === name) return 0.7;
          return 1;
        });
        src_selectAll('.bar').attr('style', function (item) {
      ...
      this.chart.on('mouseover', function (d) {
        var x = on_event.layerX - 50 - chartpadding.left;
        var y = on_event.layerY - chartpadding.top;
        src_select('.tooltip').attr('transform', "translate(".concat(x, ",").concat(y, ")")) // 提示框跟随鼠标移动
        .attr('opacity', 0.7);
        src_select('.tooltip').select('text').text("".concat(d.name, ":").concat(d.value));
      }).on('mouseout', function () {
        src_select('.tooltip').attr('opacity', 0);
      });
    },
    brushed: function brushed() {
      var select = on_event.selection;
      var xs = this.xscale;
      var d = xs.bandwidth() / 2; // 刷选中的bar透明度增加并出现边框

      src_selectAll('.bar').attr('opacity', function (item) {
        var position = xs(item.name);
        if (position + d >= select[0] && position + d <= select[1]) return 0.8;
        return 1;
      }).attr('style', function (item) {
        var position = xs(item.name);
        if (position + d >= select[0] && position + d <= select[1]) return 'stroke-width:2';
        return 'stroke-width:0';
      }); // 刷选中的legend透明度增加并出现边框

      src_selectAll('.legend').attr('style', function (item) {
        var position = xs(item.name);
        if (position + d >= select[0] && position + d <= select[1]) return 'stroke-width:1';
        return 'stroke-width:0';
      });
    },
    ...
    updateAxis: function updateAxis() {
      var ys = this.yscale; // 更新x轴

      if (this.options.xAxisPosition === 'top') {
        this.xAxis.attr('transform', 'translate(0, 0)').call(axisTop(this.xscale));
        this.xAxis.selectAll('.tick').selectAll('.axis-label').attr('transform', 'translate(0,-5)');
        this.updateYAxis();
        ys = this.yscale;
        this.chart.selectAll('.bar').attr('y', 0);
      } else {
        this.xAxis.attr('transform', "translate(0, ".concat(this.height, ")")).call(axisBottom(this.xscale));
        this.xAxis.selectAll('.tick').selectAll('.axis-label').attr('transform', 'translate(0,0)');
        this.updateYAxis();
        ys = this.yscale;
        this.chart.selectAll('.bar').attr('y', function (item) {
          return ys(item.value);
      ...
      if (this.options.yAxisIsShow) {
        if (this.options.yAxisNice) {
          ...
          switch (this.options.yAxisScale) {
            case 'scaleLinear':
              if (this.options.xAxisPosition === 'bottom') this.yscale = linear_linear().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([this.height, 0]).nice();else this.yscale = linear_linear().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([0, this.height]).nice();
              break;

            case 'scaleBand':
              this.yscale = band().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([0, this.height]).padding(0.1);
              break;

            case 'scaleOrdinal':
              if (this.options.xAxisPosition === 'bottom') this.yscale = ordinal().domain([0, src_max(this.valueArray) * 1.1]).nice();
              break;

            case 'scaleQuantize':
              if (this.options.xAxisPosition === 'bottom') this.yscale = quantize().domain([0, src_max(this.valueArray) * 1.1]).range([this.height, 0]).nice();else this.yscale = quantize().domain([0, src_max(this.valueArray) * 1.1]).range([0, this.height]).nice();
              break;

            case 'scaleTime':
              if (this.options.xAxisPosition === 'bottom') this.yscale = src_time().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([this.height, 0]).nice();else this.yscale = src_time().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([0, this.height]).nice();
              break;
          ...
          switch (this.options.yAxisScale) {
            case 'scaleLinear':
              if (this.options.xAxisPosition === 'bottom') this.yscale = linear_linear().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([this.height, 0]);else this.yscale = linear_linear().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([0, this.height]);
              break;
            ...
            case 'scaleOrdinal':
              if (this.options.xAxisPosition === 'bottom') this.yscale = ordinal().domain([0, src_max(this.valueArray) * 1.1]);
              break;

            case 'scaleQuantize':
              if (this.options.xAxisPosition === 'bottom') this.yscale = quantize().domain([0, src_max(this.valueArray) * 1.1]).range([this.height, 0]);else this.yscale = quantize().domain([0, src_max(this.valueArray) * 1.1]).range([0, this.height]);
              break;

            case 'scaleTime':
              if (this.options.xAxisPosition === 'bottom') this.yscale = src_time().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([this.height, 0]);else this.yscale = src_time().domain([0, src_max(this.valueArray) * 1.1]).rangeRound([0, this.height]);
              break;
        ...
        if (this.options.yAxisPosition === 'left') this.yAxis.attr('transform', 'translate(0, 0)').call(axisLeft(this.yscale).ticks(6));else this.yAxis.attr('transform', "translate(".concat(this.width, ",0)")).call(axisRight(this.yscale).ticks(6));
      }
    },
    updateBars: function updateBars() {
      ...
      var xs = this.xscale;
      var ys = this.yscale;
      this.chart.selectAll('rect').attr('class', 'bar').attr('x', function (item) {
        return xs(item.name);
      }).attr('width', this.xscale.bandwidth()).attr('y', function (item) {
        return ys(item.value);
      }).attr('height', function (item) {
    ...
    updateDataLabel: function updateDataLabel() {
      var ys = this.yscale;
      var h = this.height;
    ...
    updateLegendPosition: function updateLegendPosition() {
      switch (this.options.legendPosition) {
        case 'top':
          this.legendBox.attr('transform', "translate(".concat(this.width / 2 - this.legendWidth / 2, ",").concat(-this.legendHeight - 20, ")"));
          break;

        case 'bottom':
          this.legendBox.attr('transform', "translate(".concat(this.width / 2 - this.legendWidth / 2, ",").concat(this.height + 20, ")"));
          break;

        case 'left':
          this.legendBox.attr('transform', "translate(".concat(-this.legendWidth - 40, ",").concat(this.height / 2 - this.legendHeight / 2, ")"));
          break;

        case 'right':
          this.legendBox.attr('transform', "translate(".concat(this.width + 40, ",").concat(this.height / 2 - this.legendHeight / 2, ")"));
          break;

        case 'left-top':
          this.legendBox.attr('transform', "translate(".concat(-this.legendWidth - 40, ",0)"));
          break;

        case 'right-top':
          this.legendBox.attr('transform', "translate(".concat(this.width + 40, ",0)"));
          break;

        case 'left-bottom':
          this.legendBox.attr('transform', "translate(".concat(-this.legendWidth - 40, ",").concat(this.height - this.legendHeight, ")"));
          break;

        case 'right-bottom':
          this.legendBox.attr('transform', "translate(".concat(this.width + 40, ",").concat(this.height - this.legendHeight, ")"));
          break;
...
// CONCATENATED MODULE: ./src/components/bar-chart/bar-chart.vue?vue&type=script&lang=js&
 /* harmony default export */ var bar_chart_bar_chartvue_type_script_lang_js_ = (bar_chartvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/bar-chart/bar-chart.vue?vue&type=style&index=0&id=3fd5fff2&scoped=true&lang=css&
var bar_chartvue_type_style_index_0_id_3fd5fff2_scoped_true_lang_css_ = __webpack_require__("7338");
...
// CONCATENATED MODULE: ./src/components/bar-chart/bar-chart.vue
...
var component = normalizeComponent(
  bar_chart_bar_chartvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var bar_chart = (component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"15cc0b78-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/tree/tree.vue?vue&type=template&id=a98a1f60&scoped=true&
var treevue_type_template_id_a98a1f60_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{style:({width:600,height:600}),attrs:{"id":"tree-container"}})}
var treevue_type_template_id_a98a1f60_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/tree/tree.vue?vue&type=template&id=a98a1f60&scoped=true&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/tree/tree.vue?vue&type=script&lang=js&
...
/* harmony default export */ var treevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    initTree: function initTree() {
      ...
      console.log(this.options); // 指定图表的宽高

      this.width = 700 - this.chartPadding.right - this.chartPadding.left - 180;
      this.height = 700 - this.chartPadding.bottom - this.chartPadding.top - 80;
      src_select('#tree-container').style('width', '720px').style('height', '720px'); // 添加svg

      this.svg = src_select('#tree-container').append('svg').attr('style', 'background: #eee').attr('width', 700).attr('height', 700); // 添加g标签 

      this.g = this.svg.append('g').attr('class', 'chart') // 图表部分
      .attr('transform', "translate(".concat(this.chartPadding.left + 40, ", ").concat(this.chartPadding.top + 40, ")")); // 添加图表标题
      ...
      this.title.append('text').text(this.titleText).attr('x', 350).attr('y', 25).attr('text-anchor', 'middle').attr('fill', '#000');
    }
  }
});
...
// EXTERNAL MODULE: ./src/components/tree/tree.vue?vue&type=style&index=0&id=a98a1f60&scoped=true&lang=css&
var treevue_type_style_index_0_id_a98a1f60_scoped_true_lang_css_ = __webpack_require__("0d20");
...
var tree_component = normalizeComponent(
  ...
  treevue_type_template_id_a98a1f60_scoped_true_render,
  treevue_type_template_id_a98a1f60_scoped_true_staticRenderFns,
  false,
  null,
  "a98a1f60",
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"15cc0b78-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/tree-map/tree-map.vue?vue&type=template&id=7af2b792&scoped=true&
var tree_mapvue_type_template_id_7af2b792_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{style:({width:600,height:600}),attrs:{"id":"tree-map-container"}})}
var tree_mapvue_type_template_id_7af2b792_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/tree-map/tree-map.vue?vue&type=template&id=7af2b792&scoped=true&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/tree-map/tree-map.vue?vue&type=script&lang=js&
...
/* harmony default export */ var tree_mapvue_type_script_lang_js_ = ({
  name: 'TreeMap',
  props: ['options'],
  data: function data() {
    return {
  ...
  methods: {
    ...
    initTreeMap: function initTreeMap() {
      ...
      this.width = 700 - this.chartPadding.right - this.chartPadding.left - 180;
      this.height = 700 - this.chartPadding.bottom - this.chartPadding.top - 80;
      src_select('#tree-map-container').style('width', '720px').style('height', '720px'); // 添加svg

      this.svg = src_select('#tree-map-container').append('svg').attr('style', 'background: #eee').attr('width', 700).attr('height', 700); // 添加g标签 
...
// CONCATENATED MODULE: ./src/components/tree-map/tree-map.vue?vue&type=script&lang=js&
 /* harmony default export */ var tree_map_tree_mapvue_type_script_lang_js_ = (tree_mapvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/tree-map/tree-map.vue?vue&type=style&index=0&id=7af2b792&scoped=true&lang=css&
var tree_mapvue_type_style_index_0_id_7af2b792_scoped_true_lang_css_ = __webpack_require__("5376");

// CONCATENATED MODULE: ./src/components/tree-map/tree-map.vue
...
var tree_map_component = normalizeComponent(
  tree_map_tree_mapvue_type_script_lang_js_,
  tree_mapvue_type_template_id_7af2b792_scoped_true_render,
  tree_mapvue_type_template_id_7af2b792_scoped_true_staticRenderFns,
  false,
  null,
  "7af2b792",
  null
...
/* harmony default export */ var tree_map = (tree_map_component.exports);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"15cc0b78-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/sunburst/sunburst.vue?vue&type=template&id=42633710&scoped=true&
var sunburstvue_type_template_id_42633710_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{style:({width:600,height:600}),attrs:{"id":"sunburst-container"}})}
var sunburstvue_type_template_id_42633710_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/sunburst/sunburst.vue?vue&type=template&id=42633710&scoped=true&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/sunburst/sunburst.vue?vue&type=script&lang=js&
...
/* harmony default export */ var sunburstvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    // 其余与交互、更新有关的函数也都写在这里
    initSunburst: function initSunburst() {
      // 在这里编写初始化图表的代码，以下代码仅供参考，均可调整
      // 可以使用d3绘制可视化图表，具体可参考 bar chart 示例和 README.md 中的链接
      console.log(this.options); // 指定图表的宽高
      ...
      this.width = 700 - this.chartPadding.right - this.chartPadding.left - 180;
      this.height = 700 - this.chartPadding.bottom - this.chartPadding.top - 80;
      src_select('#sunburst-container').style('width', '720px').style('height', '720px'); // 添加svg

      this.svg = src_select('#sunburst-container').append('svg').attr('style', 'background: #eee').attr('width', 700).attr('height', 700); // 添加g标签 
...
// CONCATENATED MODULE: ./src/components/sunburst/sunburst.vue?vue&type=script&lang=js&
 /* harmony default export */ var sunburst_sunburstvue_type_script_lang_js_ = (sunburstvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./src/components/sunburst/sunburst.vue?vue&type=style&index=0&id=42633710&scoped=true&lang=css&
var sunburstvue_type_style_index_0_id_42633710_scoped_true_lang_css_ = __webpack_require__("eef3");

// CONCATENATED MODULE: ./src/components/sunburst/sunburst.vue
...
var sunburst_component = normalizeComponent(
  sunburst_sunburstvue_type_script_lang_js_,
  sunburstvue_type_template_id_42633710_scoped_true_render,
  sunburstvue_type_template_id_42633710_scoped_true_staticRenderFns,
  false,
  null,
  "42633710",
  null
...
/* harmony default export */ var sunburst = (sunburst_component.exports);
...
//# sourceMappingURL=visComponents.umd.js.map